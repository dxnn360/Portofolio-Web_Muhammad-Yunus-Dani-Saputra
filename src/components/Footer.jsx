...
const Footer = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // CTA text reveal
      gsap.fromTo(
        ctaRef.current?.querySelectorAll(".footer-reveal"),
        { y: 60, opacity: 0 },
        {
          y: 0,
          opacity: 1,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span
            className="section-label footer-reveal"
          ...
          <a
            ...
            className="btn-primary footer-reveal"
            data-cursor-hover
            style={{ opacity: 0, fontSize: "1rem", padding: "16px 40px" }}
          >
            <span>muhammadyunus206@gmail.com</span>
          </a>
        </div>
        ...
        >
          ...
          >
            © {currentYear} dxnn. All rights reserved.
          </p>
